			...
			<div class="content">
				<div class="page-inner mt-3">
					<div class="row mt--2">
						<div class="col">
							<div class="card">
                                <div class="card-header"><h4 style="font-size:1.5em;font-weight:bolder;margin-left:20vw">ADMINISTRATIVE AREA</h4></div>
                                <div class="card-body">
									<form action="./src/main.php" method="post">
										...
										<div class="mt-3" style="text-align:center">
											<button class="btn btn-success" name="administrative_area" type="submit">Submit</button>
										</div>
                                    </form>
                                </div>
							</div>
